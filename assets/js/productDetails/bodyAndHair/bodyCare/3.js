let count = 1;
let productID = bodyAndHairProducts.bodyCare[2].id;
let category = bodyAndHairProducts.bodyCare[2].category;
...
$('#productDetailsWrapper_img').src = createFilePath(bodyAndHairProducts.bodyCare[2].img.src);
$('#productDetailsWrapper_title').textContent = bodyAndHairProducts.bodyCare[2].title;
$('#productDetailsWrapper_price').textContent = bodyAndHairProducts.bodyCare[2].price + ' Ks';
$('#productDetailsWrapper_description').textContent = bodyAndHairProducts.bodyCare[2].description;

let count = 1;
let productID = bodyAndHairProducts.bodyCare[4].id;
let category = bodyAndHairProducts.bodyCare[4].category;
...
$('#productDetailsWrapper_img').src = createFilePath(bodyAndHairProducts.bodyCare[4].img.src);
$('#productDetailsWrapper_title').textContent = bodyAndHairProducts.bodyCare[4].title;
$('#productDetailsWrapper_price').textContent = bodyAndHairProducts.bodyCare[4].price + ' Ks';
$('#productDetailsWrapper_description').textContent = bodyAndHairProducts.bodyCare[4].description;

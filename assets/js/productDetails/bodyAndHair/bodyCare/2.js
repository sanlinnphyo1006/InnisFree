let count = 1;
let productID = bodyAndHairProducts.bodyCare[1].id;
let category = bodyAndHairProducts.bodyCare[1].category;
...
$('#productDetailsWrapper_img').src = createFilePath(bodyAndHairProducts.bodyCare[1].img.src);
$('#productDetailsWrapper_title').textContent = bodyAndHairProducts.bodyCare[1].title;
$('#productDetailsWrapper_price').textContent = bodyAndHairProducts.bodyCare[1].price + ' Ks';
$('#productDetailsWrapper_description').textContent = bodyAndHairProducts.bodyCare[1].description;

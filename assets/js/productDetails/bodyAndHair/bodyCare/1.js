let count = 1;
let productID = bodyAndHairProducts.bodyCare[0].id;
let category = bodyAndHairProducts.bodyCare[0].category;
...
$('#productDetailsWrapper_img').src = createFilePath(bodyAndHairProducts.bodyCare[0].img.src);
$('#productDetailsWrapper_title').textContent = bodyAndHairProducts.bodyCare[0].title;
$('#productDetailsWrapper_price').textContent = bodyAndHairProducts.bodyCare[0].price + ' Ks';
$('#productDetailsWrapper_description').textContent = bodyAndHairProducts.bodyCare[0].description;
